...
| P1 | 统一任务执行模型 | ✅ 已完成 | 训练/推理/采集任务状态、日志、失败语义一致 |
| P2 | 版本与文档口径统一 | ✅ 已完成 | `settings.APP_VERSION` 与发布文档一致 |
| P2 | 最小回归测试集 | ✅ 已完成 | 已覆盖 data/inference/training/points/assets/annotation 核心链路 |
| P2 | 权限与审计增强 | ✅ 已完成 | 数据资产具备 owner/组织维度与审计字段 |
| P2 | 文件角色收敛（在线链路） | ✅ 已完成 | 在线流程默认走 DB/内存 rows；文件路径仅兼容模式 |
